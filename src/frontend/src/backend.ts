...
export class Backend implements backendInterface {
    ...
    async addUpdateBrand(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addUpdateBrand(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getBrand(): Promise<Brand> {
        if (this.processError) {
            try {
                const result = await this.actor.getBrand();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
